...
def add_record():
    ...
    surety = mb.askyesno('Are you sure?',
                'Are you sure this is the data you  wish to enter?\nPlease note that BOOk ID cannot be changed in future')
    ...
    if surety:
        try:
            ...
            mb.showerror('Book ID already in use!',
                            'The Book ID you are trying to enter is already in the database, please alter that book\'s record or check any descrepanics on your side')
...
# Variables
lf_bg = '#86ED25'  # Left Frame Background Color
rtf_bg = '#26FA18'  # Right Top Frame Background Color
rbf_bg = '#B618F0'  # Right Bottom Frame Background Color
btn_hlb_bg = '#EEF411'  # Background color for Head Labels and Buttons

lbl_font = ('Georgia', 13)  # Font for all labels
entry_font = ('Times New Roman', 12)  # Font for all Entry widgets
btn_font = ('Gill Sans MT', 13)

#Intializing the main GUI window
root = Tk()
